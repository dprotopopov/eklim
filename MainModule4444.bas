...
'1.       Отобразить экранную форму
    ...
    myPictureImageFolderName = "D:\Projects\eklim\pictures uv"
            ...
            For j = 1 To t
                If k < COUNTER And CInt(AMOUNT(k)) > 0 Then
                    ...
                    If fs.FileExists(file) Then
                        ...
                        With lyr5.CreateSymbol(x1, y1, symname)
                             .SetPosition x1, y1
                             .SetSize w1, h1
                             .Copy
                         End With
