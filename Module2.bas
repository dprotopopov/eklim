...
Public myFileNameText As String 'Имя файла данных
Public myFileNameImage As String 'Имя файла данных
...
Public myMessageImageFolderName As String 'Имя папки с изображениями
Public myPictureImageFolderName As String 'Имя папки с изображениями
...
Function myMESSAGEIMAGE(model As String, title As String) As String
    Dim s1 As String, s2 As String
    s1 = Trim(Replace(model, "/", " "))
    s2 = Trim(Replace(title, "/", " "))
    myMESSAGEIMAGE = myMessageImageFolderName + "\" + s1 + "\" + s2
End Function

Function myPICTUREIMAGE(model As String, title As String) As String
    Dim s1 As String, s2 As String
    s1 = Trim(Replace(model, "/", " "))
    s2 = Trim(Replace(title, "/", " "))
    myPICTUREIMAGE = myPictureImageFolderName + "\" + s1 + "\" + s2
End Function

Function myMESSAGESYMBOL(model As String, title As String) As String
    Dim s1 As String, s2 As String
    s1 = UCase(Trim(Replace(model, "/", "_")))
    s2 = UCase(Trim(Replace(title, "/", "_")))
    myMESSAGESYMBOL = "MESSAGE-" + s1 + "-" + s2
End Function

Function myPICTURESYMBOL(model As String, title As String) As String
    Dim s1 As String, s2 As String
    s1 = UCase(Trim(Replace(model, "/", "_")))
    s2 = UCase(Trim(Replace(title, "/", "_")))
    myPICTURESYMBOL = "PICTURE-" + s1 + "-" + s2
End Function
